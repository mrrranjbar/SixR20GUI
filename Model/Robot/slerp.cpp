...
void slerp::Slerp1(Quaternion v0, Quaternion v1, Quaternion &qr, double t) {
    ...
    double sintheta = sin(theta);     // compute this value only once
    double sintheta_0 = sin(theta_0); // compute this value only once

    double s0 = cos(theta) - dot * sintheta / sintheta_0;  // == sin(theta_0 - theta) / sin(theta_0)
    double s1 = sintheta / sintheta_0;
